...
@WebServlet("/DownloadSearchFile")
public class DownloadSearchFile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	     ...
	     List<CancerBean> canr = dao.findCancer((String) request.getParameter("downloadfile"));
